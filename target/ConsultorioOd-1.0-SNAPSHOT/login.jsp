    ...
    <div class="container-form register">
        <div class="information">
            <div class="info-childs">
                <h2>Bienvenido</h2>
                <p>Si ya tienes una cuenta hecha porfavor presiona el botón de iniciar sesión</p>
        ...
        <div class="form-information">
            <div class="form-information-childs">
                ...
                <form class="form form-register" method="POST" action="SVUsuarios" novalidate>
                    <div>
                        <label>
    ...
    <div class="container-form login hide">
        <div class="information">
            <div class="info-childs">
                ...
                <p>Si no tienes una cuenta hecha presiona el botón para registrarte con tus datos</p>
